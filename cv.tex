...
\addressstyle 1907 Lincoln Way, San Francisco, CA 94122 USA \ $\cdot$ Phone: 1-301-787-3693\\
...
\begin{itemize}
\item \textbf{Languages} \ Python, C, Matlab/Octave, Java, Perl, PHP, HTML/XML
\item \textbf{Version Control} \ Mercurial, Bitbucket, Git, Github, SVN, SourceRepo
\item \textbf{OSs, Servers, Databases} \ Unix/Linux, Mac OS X, Windows, Apache, Cherokee, MySQL, SQLite, 
\item \textbf{Web Hosting} Amazon Web Services EC2/S3, Linode, Slicehost
